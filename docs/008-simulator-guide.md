...
zig build sim -- -r firmware.bin --debug -b 0x40000100

# Test with disk image
zig build sim -- -r zigpod.bin -d ipod_disk.img

# Audio playback testing
zig build sim -Dsdl2=true -- -a test_audio.wav

# Headless execution (CI/automated testing)
zig build sim -- -r test.bin --headless
```
